 ...
 * @LastEditTime: 2020-07-22 09:11:31
...
export default class Overall extends Vue {
  ...
  private tableOpt: any = {
    ...
    column: [
      ...
      { name: '流量', value: 'volume', sortable: 'custom', tooltip: true },
      ...
      { name: '起始攻击时间', value: 'beginTime', minWidth: 130, sortable: 'custom', tooltip: true },
      { name: '攻击结束时间', value: 'endTime', minWidth: 130, sortable: 'custom', tooltip: true },
      { name: '攻击IP数量', value: 'sources', minWidth: 120, sortable: 'custom', tooltip: true },
  ...
  handleTableExportBtn() {
    if (this.exportType === 0) {
      ...
      window.location.href = `${UrlExport}?${this.getParmas(this.tableformItems)}&type=1&eIp=${this.multipleSelection}&token=${getCookies('token')}`
    }
  }
  // 表格多选
